...
public interface EtcdApi {
    ...
    @Operation(summary = "Получение данных из ETCD", description = "Получение данных из ETCD", tags={ "ETCD" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Успешный запрос", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TestData.class))),
    ...
    ResponseEntity<TestData> getTestDataGET();
